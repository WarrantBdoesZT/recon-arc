...
def build_graph(exploit_mode: bool = False):
    ...
    def route_from_scope(state: ReconState) -> str:
        ...
        valid = {
            ...
            "enumerate": "enumerate",
            "analyze": "analyze",
            "exploit": "exploit" if (exploit_mode and _HAS_STRIKE) else "analyze",
            "privesc": "privesc" if (exploit_mode and _HAS_STRIKE) else "analyze",
            "lateral": "lateral" if (exploit_mode and _HAS_STRIKE) else "analyze",
            "pivot_tunnel": "pivot_tunnel" if (exploit_mode and _HAS_STRIKE) else "report",
            "flag_hunt": "flag_hunt" if (exploit_mode and _HAS_STRIKE) else "report",
